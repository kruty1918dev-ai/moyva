...
Абстракція мережевого транспорту. Реалізації: `OfflineNetworkProvider`, `RelayNetworkProvider` (заглушка), `WebSocketNetworkProvider` (заглушка).
...
| `INetworkProvider` | `WebSocketNetworkProvider` | 🔲 Заглушка |
