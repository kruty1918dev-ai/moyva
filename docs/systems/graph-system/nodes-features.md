...
1. Збираються випадкові точки на краю карти
2. Знаходиться найнижча точка (фініш)
3. Для кожної річки будується A* шлях з урахуванням висот
4. Клітинки вздовж шляху позначаються як річка
