# Generator — Система процедурної генерації карти (Pipeline)

← [Назад до README](../README.md) · [Переглянути на сайті →](https://kruty1918dev-ai.github.io/moyva/#systems/generator)

> **Нова система:** Для візуальної генерації карт через нодовий редактор, дивіться [Graph System](graph-system/README.md). Ця сторінка описує **стару pipeline-систему**, яка все ще підтримується як альтернатива.
