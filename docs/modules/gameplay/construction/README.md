...
Короткий опис: модуль Construction входить до групи gameplay та документується у стандартизованому форматі.
...
- Legacy reference: [../../../systems/construction.md](../../../systems/construction.md)
