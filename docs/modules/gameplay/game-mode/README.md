...
Короткий опис: модуль Game Mode входить до групи gameplay та документується у стандартизованому форматі.
...
- Legacy reference: [../../../systems/game-mode.md](../../../systems/game-mode.md)
