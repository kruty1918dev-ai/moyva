...
Короткий опис: модуль Pathfinding входить до групи gameplay та документується у стандартизованому форматі.
...
- Legacy reference: [../../../systems/pathfinding.md](../../../systems/pathfinding.md)
