...
Короткий опис: модуль Objects Map входить до групи world та документується у стандартизованому форматі.
...
- Legacy reference: [../../../systems/objects-map.md](../../../systems/objects-map.md)
