...
> Автоматично згенерована документація кодової бази Unity-проекту **Moyva**.  
> Усі файли написані українською мовою та пов'язані перехресними посиланнями.
...
*Документація згенерована: 2026-03-31*
