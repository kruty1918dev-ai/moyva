...
- [TDD стандарт](standards/TDD.md)
- [Naming Policy](standards/naming-policy.md)
- [Ліміти розміру файлів](standards/file-size-limits.md)
- [Common Utilities](standards/common-utilities.md)
- [ProjectContext Data Policy](standards/project-context-data-policy.md)
- [Runtime Config Lifecycle](standards/runtime-config-lifecycle.md)
- [Domain Result Pattern](standards/domain-result-pattern.md)
- [Reflection Startup Validation](standards/reflection-startup-validation.md)
...
- [Unit Designer Safe Edit Mode](standards/unit-designer-safe-edit-mode.md)
- [Unit Designer Pre-Save Validation](standards/unit-designer-pre-save-validation.md)
- [Unit Designer Batch Operations](standards/unit-designer-batch-operations.md)
- [Designer Preset System](standards/designer-preset-system.md)
- [JSON Authoring Data](standards/json-authoring-data.md)
- [Semantic Folders для Editor Tools](standards/editor-tools-semantic-folders.md)
