...
namespace Kruty1918.Moyva.Editor.Shared
{
    ...
    public static class BuildingModuleEditorCatalog
    {
            ...
            Type candidateType)
        {
            ...
            bool hasGarrison = Has<GarrisonBuildingModule>(currentModules);
            ...
            // Housing is an orthogonal economy capability and can be
            // combined with settlement or worker semantics.

            if (candidateType == typeof(WallBuildingModule) && hasGate)
                return "Будівля не може одночасно бути стіною і воротами.";
            if (candidateType == typeof(GateBuildingModule) && hasWall)
