...
namespace Kruty1918.Moyva.ObjectsMap.API
{
    ...
    /// </summary>
    /// <summary>
    /// Optional unit lifecycle extension for occupants that can temporarily
    /// share a cell with a primary map object such as a Gate.
    /// </summary>
    public interface IObjectsMapSharedOccupancy
    {
        bool TryUnregisterOccupant(string occupantId);
        bool IsSharedOccupant(string occupantId);
    }
