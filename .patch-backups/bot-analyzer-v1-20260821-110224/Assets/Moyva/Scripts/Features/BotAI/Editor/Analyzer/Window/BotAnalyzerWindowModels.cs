...
{
    [Serializable]
    internal sealed class BotAnalyzerOverviewModel
    {
    ...
    [Serializable]
    internal sealed class BotAnalyzerResourceRow
    {
    ...
    [Serializable]
    internal sealed class BotAnalyzerUnitRow
    {
    ...
    [Serializable]
    internal sealed class BotAnalyzerBuildingRow
    {
    ...
    [Serializable]
    internal sealed class BotAnalyzerRecruitmentRow
    {
        public long Queue;
        public string Unit = string.Empty;
        public string Building = string.Empty;
    ...
    [Serializable]
    internal sealed class BotAnalyzerCandidateRow
    {
    ...
    [Serializable]
    internal sealed class BotAnalyzerTimelineRow
    {
    ...
    [Serializable]
    internal sealed class BotAnalyzerFogSummary
    {
    ...
    [Serializable]
    internal sealed class BotAnalyzerMemoryRow
    {
