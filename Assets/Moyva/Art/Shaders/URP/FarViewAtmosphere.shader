Shader "Hidden/Moyva/FarViewAtmosphere"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 _MoyvaFarViewVeil2;     // x:coverage y:octaves z:vignetteStrength w:vignetteRadius
            ...
            Varyings Vert(Attributes input)
            {
                ...
                float3 midWS = ComputeWorldSpacePosition(output.uv, 0.5, unity_MatrixInvVP);
            ...
            float4 FragComposite(Varyings input) : SV_Target
            {
                ...
                float rawDepth = hasDepth ? SampleSceneDepth(uv) : 0.0;
                ...
                // Local mean via 4 cross taps; detail = color - mean is scaled
                ...
                if (debugMode == 4 || (flattenK > 0.001 && debugMode == 0))
                {
                    ...
                    // Performance tier: 2 taps (axis-aligned pair) instead of 4.
