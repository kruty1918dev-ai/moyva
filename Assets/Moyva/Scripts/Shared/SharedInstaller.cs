...
namespace Kruty1918.Moyva.Shared
{
    ...
    public sealed class SharedInstaller : MonoInstaller
    {
        ...
        public static void Install(DiContainer container)
        {
            ...
            container.Bind<IExpensiveServiceBudgetScheduler>()
                .To<ExpensiveServiceBudgetScheduler>()
                .AsSingle();

            container.Bind<IObjectPoolingPolicyService>()
                .To<ObjectPoolingPolicyService>()
                .AsSingle();
    ...
    public sealed class AudioService : IAudioService, IInitializable, ITickable, IDisposable
    {
        ...
        private AudioHandle PlayInternal(string key, AudioPlayOptions options, string sceneNameForOverrides)
        {
            ...
            if (_sceneOverrides != null)
            {
                ...
                {
                    if (ov.OverrideVolume)       source.volume                = Mathf.Clamp01(ov.Volume * options.VolumeScale);
