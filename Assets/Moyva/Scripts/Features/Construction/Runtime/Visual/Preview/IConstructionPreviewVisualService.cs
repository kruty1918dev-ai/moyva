...
namespace Kruty1918.Moyva.Construction.Runtime
{
    internal interface IConstructionPreviewVisualService
    {
        ...
        void MoveDragVisual(Vector2Int position, string buildingId, Vector3 worldPosition, bool snapToGrid, bool hasSnapTarget, Vector2Int snapTargetPosition, bool isSnapTargetValid, float visualOffsetY = 0f);
