...
namespace Kruty1918.Moyva.Construction.UI
{
    ...
    public class BuildingButtonUI : MonoBehaviour
    {
        ...
        private float disabledVisualAlpha = 0.45f;
        private CanvasGroup _availabilityCanvasGroup;
        ...
        private void Awake()
        {
            ...
            _availabilityCanvasGroup = GetComponent<CanvasGroup>();
            if (_availabilityCanvasGroup == null)
        ...
        public void Setup(BuildingListItemData data, Action<string> onClick)
        {
            ...
            {
                if (_availabilityCanvasGroup != null)
                    _availabilityCanvasGroup.alpha = data.IsInteractable
                        ? 1f
                        : disabledVisualAlpha;
