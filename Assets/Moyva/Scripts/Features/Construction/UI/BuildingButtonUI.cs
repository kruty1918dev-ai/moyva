...
namespace Kruty1918.Moyva.Construction.UI
{
    ...
    /// 1. Create a UI Button GameObject (GameObject → UI → Button - TextMeshPro).
    /// 2. Add this component to it.
    /// 3. Assign the <b>label</b> field to the button's child TextMeshProUGUI component.
    ...
    {
        [Tooltip("TextMeshProUGUI component showing the building display name.")]
