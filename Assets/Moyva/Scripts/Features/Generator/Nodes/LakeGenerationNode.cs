...
{
    [NodeInfo("Lake Generation", "Features")]
    public sealed class LakeGenerationNode : NodeBase
    {
        ...
        [SerializeField] private string _deepWaterTile = "water_deep";
        [SerializeField] private string _shallowWaterTile = "water_shallow";
        [SerializeField, Range(0f, 0.1f)] private float _shallowDepth = 0.05f;
        [SerializeField] private string _shoreTile = "shore";
        ...
        public override NodeOutput Execute(object[] inputs, NodeContext context)
        {
            ...
            for (int x = 0; x < w; x++)
            {
                for (int y = 0; y < h; y++)
                {
                    ...
                    var basin = FloodFill(heightMap, visited, x, y, w, h, _waterLevel);
        ...
        private static List<Vector2Int> FloodFill(float[,] heightMap, bool[,] visited,
            int startX, int startY, int w, int h, float threshold)
        {
