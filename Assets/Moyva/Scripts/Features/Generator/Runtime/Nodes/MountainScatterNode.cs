...
namespace Kruty1918.Moyva.Generator.Runtime.Nodes
{
    ...
    {
        [Tooltip("Мінімальна висота для цього шару гірських об'єктів. Дозволяє відокремити скелі, пагорби та великі гори за висотними поясами.")]
        [Range(0f, 1f)] public float MinHeight = 0.65f;
        [Tooltip("Максимальна висота для шару. Разом із MinHeight визначає, у якому поясі може з'явитися цей тип каменя або гори.")]
        [Range(0f, 1f)] public float MaxHeight = 1f;
        [Tooltip("ID об'єкта, який буде ставитися в цьому висотному шарі. Це може бути велика гора, невелика скеля або інший кам'яний об'єкт.")]
        [MapObjectId] public string ObjectId = "mountain-large";
        [Tooltip("Базова щільність спавну об'єктів цього шару. Вищі значення дають більш насичені кам'яні області.")]
        [Range(0f, 1f)] public float Density = 0.4f;
    }

    [NodeInfo("Mountain Scatter", "Features", "Розкидає гірські та скельні об'єкти по карті залежно від висоти. Дає швидкий спосіб наситити високі області рельєфу валунами, скелями й гірськими піками.")]
    public sealed class MountainScatterNode : NodeBase
    {
        [Header("Mountain Layers")]
        [Tooltip("Список висотних шарів гірських об'єктів. Кожен шар описує власний тип об'єкта, його висотний діапазон і густоту розміщення.")]
        [SerializeField] private MountainLayer[] _layers = new[]
        {
            new MountainLayer { MinHeight = 0.75f, MaxHeight = 1f, ObjectId = "mountain-large", Density = 0.6f },
