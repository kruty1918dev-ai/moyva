...
{
    [NodeInfo("Smooth", "Processing", "Згладжує карту висот простим усередненням сусідніх значень. Підходить для прибираня шумових артефактів, пом'якшення рельєфу та підготовки карти до подальших кроків генерації.")]
