...
{
    [NodeInfo("Terrace", "Processing", "Перетворює плавний рельєф на терасований, зі східчастими рівнями висоти. Корисно для стилізованих карт, плато, сільськогосподарських терас або більш читабельного ігрового рельєфу.")]
    public sealed class TerraceNode : NodeBase
    {
        [Header("Terrace Settings")]
        [Tooltip("Кількість висотних рівнів після терасування. Менше значення дає грубі широкі сходинки, більше — дрібніші й делікатніші тераси.")]
        [SerializeField, Range(2, 20)] private int _levels = 5;
        [Tooltip("Сила притягування до східчастих рівнів. 0 майже зберігає оригінал, 1 повністю переводить карту у виражені тераси.")]
