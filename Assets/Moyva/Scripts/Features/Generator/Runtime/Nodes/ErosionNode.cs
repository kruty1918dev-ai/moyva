...
{
    [NodeInfo("Erosion", "Processing", "Застосовує спрощену термальну ерозію до карти висот. Дає змогу зменшити різкі піки, зробити схили природнішими та підготувати рельєф до подальшого біомного розфарбування.")]
    public sealed class ErosionNode : NodeBase
    {
        [Header("Erosion Settings")]
        [Tooltip("Швидкість перенесення висоти зі схилу в нижчу точку. Вищі значення сильніше згладжують перепади та швидше руйнують круті форми рельєфу.")]
        [SerializeField, Range(0.001f, 0.1f)] private float _erosionRate = 0.01f;
        [Tooltip("Кількість проходів ерозії по карті. Кожна ітерація поступово згладжує рельєф, тому велика кількість дає помітніший ефект.")]
        [SerializeField, Range(1, 50)] private int _iterations = 10;
        [Tooltip("Поріг різниці висот, після якого починається перенесення матеріалу. Дозволяє контролювати, наскільки крутий схил вважається нестабільним.")]
