...
namespace Kruty1918.Moyva.Generator.Runtime.Nodes
{
    ...
    [NodeInfo("Map Scale", "Utility", "Масштабує карту висот до нового розміру. Може використовуватись для збільшення деталізації перед наступними етапами або для приведення карт різного розміру до спільного формату.")]
    public sealed class MapScaleNode : NodeBase
    {
        [Header("Scale Settings")]
        [Tooltip("Множник масштабу для ширини та висоти карти. Значення більше 1 збільшує карту, менше 1 — зменшує її.")]
        [SerializeField, Range(0.1f, 4f)] private float _scaleFactor = 2f;
        [Tooltip("Метод інтерполяції при масштабуванні. NearestNeighbour зберігає різкі переходи, Bilinear робить результат плавнішим.")]
