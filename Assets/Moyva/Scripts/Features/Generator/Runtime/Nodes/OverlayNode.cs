...
{
    [NodeInfo("Overlay", "Utility", "Накладає одну карту тайлів поверх іншої з можливістю обмеження маскою. Підходить для локального домальовування спеціальних зон без повного перерахунку всієї базової карти.")]
