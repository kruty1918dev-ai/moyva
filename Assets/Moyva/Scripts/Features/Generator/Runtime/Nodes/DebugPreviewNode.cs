...
{
    [NodeInfo("Debug Preview", "Debug", "Допоміжна нода для відлагодження, яка пропускає дані далі без змін, але може друкувати статистику у консоль. Корисна для швидкої перевірки масок, мап висот і набору тайлів у середині графа.")]
    public sealed class DebugPreviewNode : NodeBase
    {
        [Header("Debug Settings")]
        [Tooltip("Текстова мітка для логів цієї ноди. Дозволяє легко відрізняти кілька debug-вузлів у консолі під час аналізу графа.")]
        [SerializeField] private string _label = "Debug";
        [Tooltip("Чи виводити статистику в Unity Console під час виконання ноди. Якщо вимкнути, нода працюватиме як прозорий passthrough без шуму в логах.")]
