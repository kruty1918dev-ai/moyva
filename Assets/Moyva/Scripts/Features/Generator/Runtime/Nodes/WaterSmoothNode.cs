...
{
    [NodeInfo("Water Smooth", "Features", "Запускає постобробку води для згладження меж, розширення водних зон і прибирання грубих артефактів. Зазвичай ставиться після генерації озер і річок, коли потрібно зробити воду візуально ціліснішою.")]
