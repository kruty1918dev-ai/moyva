...
namespace Unity.Networking.Transport
{
    ...
    internal struct NetworkPipelineProcessor : IDisposable
    {
            ...
            out NativeArray<byte> sharedBuffer)
        {
            ...
            writeProcessingBuffer = m_SendBuffer.AsArray().GetSubArray(sendBufferOffset, m_StageCollection[m_StageList[stageIndexInList]].SendCapacity);
            readProcessingBuffer = m_ReceiveBuffer.AsArray().GetSubArray(recvBufferOffset, m_StageCollection[m_StageList[stageIndexInList]].ReceiveCapacity);
            sharedBuffer = m_SharedBuffer.AsArray().GetSubArray(sharedBufferOffset, m_StageCollection[m_StageList[stageIndexInList]].SharedStateCapacity);
        }
